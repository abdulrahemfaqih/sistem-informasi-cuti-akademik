        ...
        <div class="w-full mb-1 p-4">
            <div class="mb-4">
                ...
                <div class="overflow-x-auto max-w-full">
                    <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden" id="data-table">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Program Studi</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($tanggungan as $index => $item)
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-700">{{ $item->mahasiswa->prodi->nama }}</td>
